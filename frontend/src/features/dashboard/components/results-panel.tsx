...
> = {
  ...
  MANUFACTURER_MISMATCH: {
    ...
    description: 'Manufacturer verification failed',
  },
  EXTRACTED: {
    icon: CheckCircle2,
    ...
    description: 'IC data extracted successfully',
  },
  NEED_BOTTOM_SCAN: {
    icon: AlertTriangle,
    label: 'Bottom Scan Needed',
    color: 'text-amber-500',
    bgColor: 'bg-amber-500/10',
    borderColor: 'border-amber-500/20',
    description: 'Flip IC and scan bottom side',
  },
  MATCH_FOUND: {
    icon: CheckCircle2,
    label: 'Match Found',
    ...
    description: 'IC found in database',
  },
  PIN_MISMATCH: {
    icon: XCircle,
    label: 'Pin Mismatch',
    ...
    bgColor: 'bg-red-500/10',
    borderColor: 'border-red-500/20',
    description: 'Part number found but pin count mismatch',
  },
  NOT_IN_DATABASE: {
    icon: HelpCircle,
    ...
    bgColor: 'bg-zinc-500/10',
    borderColor: 'border-zinc-500/20',
    description: 'IC not found, added to sync queue',
  },
}
